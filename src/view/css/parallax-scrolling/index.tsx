...
const ParallaxScrolling: React.FC = () => {
  const htmlCode = `
		<div class="bgimg-1">
		<div class="caption">
  ...
  const cssCode = `
		...
		.bgimg-4{
				background-image: url(https://www4.bing.com//th?id=OHR.BradgateFallow_ZH-CN1852334581_1920x1080.jpg&rf=LaDigue_1920x1080.jpg&pid=hp);
				min-height: 400px;
		}
			`
